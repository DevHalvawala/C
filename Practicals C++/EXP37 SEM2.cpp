/*Create a class Media that stores the title (a string) and price (float). Class Media has
...
as  its  own data  members  and  display  (  )  function which  displays  book  details
and tape details respectively. Write a main ( ) to test book and tape classes by creating
instances of them, asking the user to fill data and displaying them.
...
void display()
{
    ...
    cout << "Page numbers: " << pagecount << endl; cout << endl;
  }
};
