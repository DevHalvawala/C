/*Create a Class Date having data members: int dd, mm, yyyy. Class has one
member function to input the dates and another member function which prints
the dates. Write a main() function which takes two dates as input. Write a
...
public:
    ...
    friend void swap(date &d1, date &d2)
    {
        ...
        cout<<"\nAfter swapping..."<<endl;
        cout<<d1.date_<<"/"<<d1.month<<"/"<<d1.year<<endl<<d2.date_<<"/"<<d2.month<<"/"<<d2.year;
    }
};
int main()
{
